...
const ACTIVITY = [
  ...
  activity(
    ...
    "broker-started",
    "info",
    "VenueBroker is healthy and accepting requests.",
  ),
  activity(
  ...
  activity(
    ...
    "application-started",
    "info",
    "Signal Collector connected through VenueBroker.",
  ),
  activity(
    "2026-09-13T14:14:01.000Z",
    "application-started",
    "info",
    "Market Research connected through VenueBroker.",
  ),
];
...
export const brokerDown = snapshot({
  ...
  activity: [
    activity(
      ...
      "broker-started",
      "critical",
      "VenueBroker stopped answering. The last good sample is 1m old.",
    ),
    ...ACTIVITY.slice(1),
  ],
});
...
export const counterReset = snapshot({
  ...
  activity: [
    activity(
      ...
      "restart",
      "info",
      "VenueBroker started again. Counters restart from zero at this point.",
    ),
    ...ACTIVITY,
  ],
